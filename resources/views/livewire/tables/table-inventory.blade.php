<div
    class="relative overflow-hidden overflow-x-auto border-1 border-solid rounded-lg border-gray-200 dark:border-gray-700">
    <div
        class="px-3 flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-3 bg-white dark:bg-gray-900">
