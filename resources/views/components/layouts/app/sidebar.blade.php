            ...
            @role('super_admin')
                ...
                <li>
                    <a href="{{ route('inventory') }}" wire:navigate
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">{{ __('Inventory') }}</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('rider') }}" wire:navigate
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                            <path
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">{{ __('Rider') }}</span>
                    </a>
                </li>
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">{{ __('Events') }}</span>
